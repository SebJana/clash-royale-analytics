...
class ClashRoyaleAPI:
    ...
    def __init__(self, api_key: str, base_url: str = CLASH_BASE_URL, timeout_s: float = 5.0):
    ...
    async def _request(self, endpoint: str):
        ...
        if self._client is None:
            raise RuntimeError("HTTP client is closed. Create a new instance or call within an async context.")
